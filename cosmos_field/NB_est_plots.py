...
plt.plot(nb527['M1450'], nb527['DIST']/4.3, 'r', label='Distance to Gamma_QSO = Gamma_UVB in NB527 (z=3.3)')
plt.plot(nb718['M1450'], nb718['DIST']/5.9, 'g', label='Distance to Gamma_QSO = Gamma_UVB in NB718 (z=4.9)')
plt.plot(nb816['M1450'], nb816['DIST']/6.7, 'b', label='Distance to Gamma_QSO = Gamma_UVB in NB816 (z=5.7)')

plt.hlines(mean_sep_527.value/4.3,-22,-27, 'r', linestyles='--', label='Mean Sightline Separation in NB527 (z=3.3)')
plt.hlines(mean_sep_718.value/5.9,-22,-27, 'g', linestyles='--', label='Mean Sightline Separation in NB718 (z=4.9)')
plt.hlines(mean_sep_816.value/6.7,-22,-27, 'b', linestyles='--', label='Mean Sightline Separation in NB816 (z=5.7)')

plt.xlim(-22, -27)
plt.ylim(0,8)
plt.xlabel(r'M_{1450}')
plt.ylabel('Distance (cMpc)')
plt.legend()
plt.show()