...
#gamma_UVB = 0.50458885e-12 * u.s ** -1  # Gamma_UVB at z = 5.7 (From 5.5 Nyx sims)
gamma_UVB = 0.224e-12 * u.s ** -1  # Gamma_UVB at z = 5.7 (From Gaikwad 2019)
ang = 12.6 * u.arcmin  # Using sightline resolution from Koki NASA/Keck 2023A proposal
...
if run_full_loop:
    ...
    plt.plot(M1450_range, dist_vals, 'b', label='Distance to Gamma_QSO = Gamma_UVB in NB816 (z=5.7)')
    plt.hlines(mean_sep.value,-22,-27, 'b', linestyles='--', label='Mean Sightline Separation in NB816 (z=5.7)')
    plt.xlim(-22, -27)
    ...
    np.savez('NB816_mag_dist', M1450=M1450_range, DIST=dist_vals)
    ...
    print("The mean sightline separation at z = 5.7 in this field:      " + str(np.round(mean_sep, 4)))
    print('\n')
