...
#gamma_UVB = 0.8105875e-12 * u.s ** -1  # Gamma_UVB at z = 4.9 (From 5.0 Nyx sims)
gamma_UVB = 0.501e-12 * u.s ** -1  # Gamma_UVB at z = 4.9 (From Gaikwad 2019)
ang = 4.8 * u.arcmin  # Using sightline resolution from Koki NASA/Keck 2023A proposal
...
if run_full_loop:
    ...
    plt.plot(M1450_range, dist_vals, 'g', label='Distance to Gamma_QSO = Gamma_UVB in NB718 (z=4.9)')
    plt.hlines(mean_sep.value,-22,-27, 'g', linestyles='--', label='Mean Sightline Separation in NB718 (z=4.9)')
    plt.xlim(-22, -27)
    ...
    np.savez('NB718_mag_dist', M1450=M1450_range, DIST=dist_vals)
    ...
    print("The mean sightline separation at z = 4.9 in this field:      " + str(np.round(mean_sep, 4)))
    print('\n')
